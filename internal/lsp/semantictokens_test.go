...
`,
			expectedTokens: []semanticTokenInstance{
				...
				{DeltaLine: 0, DeltaCol: 14, Length: 3},
				{DeltaLine: 2, DeltaCol: 14, Length: 6, Type: 1, Modifier: 1},
				{DeltaLine: 2, DeltaCol: 15, Length: 6, Type: 1, Modifier: 4},
			},
		},
		"imports": {
			policy: `package regal.woo
...
`,
			expectedTokens: []semanticTokenInstance{
				...
				{DeltaLine: 0, DeltaCol: 14, Length: 3},
				{DeltaLine: 2, DeltaCol: 14, Length: 6, Type: 1, Modifier: 1},
				{DeltaLine: 1, DeltaCol: 12, Length: 6, Type: 1, Modifier: 4},
				{DeltaLine: 5, DeltaCol: 15, Length: 6, Type: 1, Modifier: 4},
			},
		},
		"comprehensions": {
			policy: `package regal.woo
...
object_comprehensions := {k: v |
    ...
    v == 2
			...
			expectedTokens: []semanticTokenInstance{
				{Length: 7, Type: 3},
				{DeltaLine: 0, DeltaCol: 14, Length: 3},
				{DeltaLine: 2, DeltaCol: 25, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 1, DeltaCol: 9, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 0, DeltaCol: 3, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 4, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 3, DeltaCol: 23, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 1, DeltaCol: 9, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 0, DeltaCol: 3, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 4, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 3, DeltaCol: 26, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 0, DeltaCol: 3, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 1, DeltaCol: 9, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 0, DeltaCol: 3, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 4, Length: 1, Type: 1, Modifier: 4},
			},
    ...
    every k in input.object {
        is_string(k)
			...
			expectedTokens: []semanticTokenInstance{
				{Length: 7, Type: 3},
				{DeltaLine: 0, DeltaCol: 14, Length: 3},
				{DeltaLine: 3, DeltaCol: 10, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 0, DeltaCol: 3, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 18, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 1, DeltaCol: 8, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 5, DeltaCol: 10, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 18, Length: 1, Type: 1, Modifier: 4},
			},
		},
		"some vars": {
...
some_one_var_construct if {
    ...
    i < 10
			...
			expectedTokens: []semanticTokenInstance{
				{Length: 7, Type: 3},
				{DeltaLine: 0, DeltaCol: 14, Length: 3},
				{DeltaLine: 3, DeltaCol: 9, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 0, DeltaCol: 3, Length: 4, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 4, Length: 1, Type: 1, Modifier: 4},
				{DeltaLine: 1, DeltaCol: 4, Length: 4, Type: 1, Modifier: 4},
				{DeltaLine: 4, DeltaCol: 9, Length: 1, Type: 1, Modifier: 2},
				{DeltaLine: 1, DeltaCol: 4, Length: 1, Type: 1, Modifier: 4},
			},
		},
	}
